...
| | |
|---|---|
| `generate(newvarname)` | Name of the Stata variable that stores core membership; default = *_core* |
...
- [nwconcor](nwconcor.md), [nwcommunity](nwcommunity.md), [nwconstraint](nwconstraint.md)
