...
`nwwebuse` *filename* loads the specified network dataset, obtaining it over the web and [sets all networks](nwset.md) in this dataset. By default, datasets are obtained from *https://raw.githubusercontent.com/thomas-u-grund/nwcommands/develop/data*.
...
`nwwebuse` `set` without arguments resets the source to *https://raw.githubusercontent.com/thomas-u-grund/nwcommands/develop/data*.
...
- `. nwwebuse https://raw.githubusercontent.com/thomas-u-grund/nwcommands/develop/data/florentine`
