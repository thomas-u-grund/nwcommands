...
Normally, there is no need to explicitly call **_nwdatasync**. All other nwcommands that make use of variables in the Stata dataset (e.g. node attributes) sync automatically.
...
. _nwdatasync mynet, generate(innet)
. list innet
```
