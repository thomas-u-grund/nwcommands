...
{p2colset 9 15 19 2}{...}
{p2col :{cmd:nw_unab} {hline 2}}Unabbreviate network list{p_end}
{p2colreset}{...}
...
{p 8 13 2}{cmd:nw_unab} {it:lmacname} {cmd::} {it:{help netlist}} [{cmd:,}
...
{title:Examples}
	...
	{cmd:. nw_unab nets : flo*}
	{cmd:. di "`nets'"}
	     {txt}flobsuiness flomarriage
